...
export default function App() {
  ...
  const clickHandler = (e) => {
    ...
    switch(param) {
      ...
      case 'NAME':
        setDisp('Mandanas Patricia Marie'); break;
      case 'What I learned?':
        setDisp('Last semester I think I did a good job since I do not have any special talent when it comes on programming.Creating simple apps makes me feel very amezed.'); break;
      case 'What I want to learn?':
        setDisp('I want to learned deeply more about web or software development.'); break;
      case 'How will I learn?':
        setDisp('I believe applying those 10 things that requires zero talent suited for me. I understand that the path I walking right now is hard but I will do my best.'); break;
      default:
  ...
  return (
    <div className="App">
      <div className="CalcContainer">
        <h1>MANDANAS PATRICIA MARIE - IT3A</h1>
